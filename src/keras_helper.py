...
from tensorflow.contrib.keras.api.keras.optimizers import Adam, Nadam
...
class AmazonKerasClassifier:
    ...
    def train_model(self, x_train, y_train, learn_rate=0.001, epoch=5, batch_size=128, validation_split_size=0.2, train_callbacks=()):
        ...
        opt = Nadam(lr=learn_rate, beta_1=0.9, beta_2=0.999, epsilon=1e-08, schedule_decay=0.004)
